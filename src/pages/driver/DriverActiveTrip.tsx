    ...
    <div className="h-screen flex flex-col bg-gray-100 overflow-hidden relative">
      ...
      <div className="relative z-10 bg-white/90 backdrop-blur-md p-4 shadow-sm flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-mzansi-green/10 rounded-full flex items-center justify-center text-mzansi-green">
            <Navigation className="w-5 h-5" />
          </div>
          <div>
            <h2 className="font-bold text-gray-900">Cape Town CBD</h2>
            <p className="text-xs text-gray-500">ETA: 45 mins • 12km</p>
          </div>
        </div>
      ...
      <AnimatePresence>
        {incomingRequest && pickupMode === 'manual' && (
          ...
          >
            <Card className="p-4 border-l-4 border-l-mzansi-yellow shadow-lg">
              <div className="flex justify-between items-start mb-3">
                <div>
                  <h3 className="font-bold text-gray-900">New Passenger Request</h3>
      ...
      <div className="mt-auto relative z-10 bg-white rounded-t-3xl shadow-[0_-8px_30px_rgba(0,0,0,0.12)] p-6 pb-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-500 text-sm">On route to destination</p>
          </div>
        ...
        {passengers >= capacity - 2 && (
          <div className="mb-4 bg-orange-50 border border-orange-200 text-orange-800 px-4 py-3 rounded-xl flex items-center gap-3 text-sm">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-gray-100">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-white rounded-full shadow-sm flex items-center justify-center text-gray-600">
                <Settings2 className="w-5 h-5" />
              </div>
              <div>
                <p className="font-semibold text-gray-900">Pickup Mode</p>
            ...
            {/* Custom Toggle */}
            <button 
              className={`w-14 h-8 rounded-full p-1 transition-colors duration-300 ease-in-out ${pickupMode === 'automatic' ? 'bg-mzansi-green' : 'bg-gray-300'}`}
              onClick={() => {
