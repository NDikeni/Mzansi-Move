    ...
    <div className="h-screen flex flex-col bg-mzansi-black overflow-hidden relative">
      ...
      <div className="relative z-10 bg-gray-900/90 backdrop-blur-md p-4 shadow-sm flex items-center justify-between border-b border-gray-800">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-mzansi-blue/20 rounded-full flex items-center justify-center text-blue-400">
            <User className="w-5 h-5" />
          </div>
          <div>
            <h2 className="font-bold text-white">Driver: Lethabo</h2>
            <div className="flex items-center gap-1 text-xs font-medium text-green-400">
              <ShieldCheck className="w-3 h-3" /> 92% Safety Score
            </div>
          </div>
        </div>
        <button className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-400">
      ...
      {status === 'waiting' && (
        ...
        >
          <Card className="p-4 bg-mzansi-yellow/20 border-mzansi-yellow text-center">
            <p className="text-sm font-medium text-gray-300">Your Queue Position</p>
            <p className="text-3xl font-black text-white my-1">#2</p>
            <p className="text-xs text-gray-400">Driver is dropping off #1 nearby</p>
          </Card>
        </motion.div>
      )}
